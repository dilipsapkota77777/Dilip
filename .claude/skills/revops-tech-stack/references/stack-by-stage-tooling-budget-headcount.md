---
title: "Stack by Stage — Tooling, Budget & Headcount"
...
Stage-appropriate stack composition with tool lists, total tool counts, and annual budget ranges. Use alongside the Golden Rule "Stage-Appropriate Complexity" in SKILL.md.
