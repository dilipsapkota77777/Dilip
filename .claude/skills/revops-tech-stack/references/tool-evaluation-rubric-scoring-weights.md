---
title: Tool Evaluation Rubric — Scoring Weights
...
The four scoring dimensions and their decision weights for evaluating a new tool. The evaluation narrative and the build-vs-buy logic remain in SKILL.md.
